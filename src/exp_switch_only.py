...
def main():
    ...
    params_asm = get_binary_params(file_path, vtable_img_offset=0x0, skip_reset_header=0)
    ...
    t = Template(template_string_Exp_Switch_Only)
    with open("make_target.S", "w") as f:
        f.write(t.substitute(params_asm))
